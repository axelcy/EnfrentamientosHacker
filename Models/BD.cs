...
public static class BD
{
    ...
    private static string _connectionString = @"Server=A-PHZ2-CIDI-027;DataBase=BD-Enfrentamientos;Trusted_Connection=True";
    ...
    {
        string sql = $"INSERT INTO Registros([IdLuchador1], [Luchador1], [Puntuacion1], [IdLuchador2], [Luchador2], [Puntuacion2], [Diff], [Fecha]) VALUES({registro.IdLuchador1}, '{registro.Luchador1}', {registro.Puntuacion1}, {registro.IdLuchador2}, '{registro.Luchador2}', {registro.Puntuacion2}, '{registro.Diff}', @Fecha)";
        using (SqlConnection bd = new SqlConnection(_connectionString)) bd.Execute(sql, new {Fecha = registro.Fecha});
    }
